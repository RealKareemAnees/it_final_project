...
async function handleRequest(req: IncomingMessage, res: ServerResponse) {
  ...
  // Allow all origins for development (permissive CORS)
  // Note: when using credentials, wildcard '*' cannot be used.
  // This sets a permissive policy that allows requests from any origin.
